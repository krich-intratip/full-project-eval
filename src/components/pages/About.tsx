...
const VERSION_HISTORY = [
    {
        ...
        date: '30 มกราคม 2569',
        changes: [
            'ระบบเกณฑ์ประเมินแบบยืดหยุ่น (Flexible Rubric System)',
            'เพิ่มเกณฑ์ประเมินโครงการวิจัยทหาร 4 หมวด 12 ข้อ',
            'Dashboard แสดงผลประเมินล่าสุด',
            'ปรับปรุงหน้าคู่มือการใช้งาน',
            'ปรับปรุงหน้า About ให้มี sub-tabs'
        ]
    },
    {
        version: 'v2.1.0',
        date: '28 มกราคม 2569',
        changes: [
            'เพิ่ม QR Code Modal พร้อม zoom และ download',
            'ปรับปรุง UI/UX ของหน้าหลัก'
        ]
    },
    {
        version: 'v2.0.1',
    ...
    },
    {
        ...
        date: '25 มกราคม 2569',
        changes: [
            'รองรับหลาย AI Provider (Gemini, OpenAI, OpenRouter)',
            'เพิ่มระบบ Roadmap การพัฒนา',
            'ปรับปรุงการแสดงผลคำแนะนำ'
        ]
    },
    {
        version: 'v1.0.0',
        date: '20 มกราคม 2569',
        changes: [
            'เปิดตัวระบบประเมินคุณภาพงานวิจัย',
            'ผู้ทรงคุณวุฒิ AI 3 ท่าน',
            'เกณฑ์ประเมิน 8 หัวข้อ'
        ]
    }
];
    ...
    return (
        <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="p-4 bg-gradient-to-r from-[#BBDEFB] to-white rounded-lg">
                                    ...
                                    <h4 className="font-semibold mb-1">อัปโหลด PDF</h4>
                                    <p className="text-sm text-gray-600">
                                        รองรับไฟล์ PDF สูงสุด 25MB พร้อมแปลงข้อความอัตโนมัติ
                                    </p>
                                </div>
                                ...
                                <div className="p-4 bg-gradient-to-r from-[#B2DFDB] to-white rounded-lg">
                                    ...
                                    <h4 className="font-semibold mb-1">Roadmap การพัฒนา</h4>
                                    <p className="text-sm text-gray-600">
                                        แผนการพัฒนาโครงการพร้อม timeline
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                                ...
                                <ul className="text-sm text-blue-700 space-y-1">
                                    ...
                                    <li>• รองรับไฟล์ PDF สูงสุด 25MB</li>
                                </ul>
                            </div>
            ...
            <QRCodeModal
                ...
                downloadFileName="donation-qr-sar.jpg"
            />
        </div>
    );
}
